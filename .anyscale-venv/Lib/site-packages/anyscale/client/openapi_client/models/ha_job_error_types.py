...
class HaJobErrorTypes(object):
    ...
    allowed enum values
    """
    RAY_JOB_FAILURE = "RAY_JOB_FAILURE"
    RAY_JOB_SUBMISSION_FAILURE = "RAY_JOB_SUBMISSION_FAILURE"
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """HaJobErrorTypes - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HaJobErrorTypes):
            return False
