...
class ResourceAlertEventType(object):
    ...
    WORKSPACE_LONG_RUNNING = "NOTIFICATION_EVENT_TYPE_WORKSPACE_LONG_RUNNING"

    allowable_values = [JOB_FAILED, JOB_SUCCEEDED, JOB_RETRYING, SERVICE_UNHEALTHY, SERVICE_RUNNING, SERVICE_ROLLING_OUT, SERVICE_ROLLING_BACK, JOB_LONG_RUNNING, WORKSPACE_LONG_RUNNING]  # noqa: E501
