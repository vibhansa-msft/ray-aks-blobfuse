...
class NodeRegistrationV2(object):
    ...
    def __init__(self, aws=None, gcp=None, provisioned=None, k8s=None, provider=None, cloud_id='', cluster_id='', local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def k8s(self):
        """Gets the k8s of this NodeRegistrationV2.  # noqa: E501


        :return: The k8s of this NodeRegistrationV2.  # noqa: E501
    ...
    @k8s.setter
    def k8s(self, k8s):
        """Sets the k8s of this NodeRegistrationV2.


        :param k8s: The k8s of this NodeRegistrationV2.  # noqa: E501
