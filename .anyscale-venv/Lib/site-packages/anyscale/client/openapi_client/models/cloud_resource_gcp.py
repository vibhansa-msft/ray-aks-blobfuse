...
class CloudResourceGCP(object):
    ...
    def user_tag_annotation_prefix(self):
        """Gets the user_tag_annotation_prefix of this CloudResourceGCP.  # noqa: E501

        Prefix for user-defined tag annotations on K8s pods. If not set, tags are added without any prefix.  # noqa: E501

        :return: The user_tag_annotation_prefix of this CloudResourceGCP.  # noqa: E501
        :rtype: str
        """
    ...
    def user_tag_annotation_prefix(self, user_tag_annotation_prefix):
        """Sets the user_tag_annotation_prefix of this CloudResourceGCP.

        Prefix for user-defined tag annotations on K8s pods. If not set, tags are added without any prefix.  # noqa: E501

        :param user_tag_annotation_prefix: The user_tag_annotation_prefix of this CloudResourceGCP.  # noqa: E501
        :type: str
        """
